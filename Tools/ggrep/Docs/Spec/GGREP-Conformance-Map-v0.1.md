...
| IDX.MUST.003 | Durability barrier before manifest write | Snapshot/Index Contracts | Integration test | `tests::conformance::durability_barrier_before_manifest` |
...
| IPC.MUST.002 | IPC framing + payload caps enforced | Query/Daemon Contracts | Fuzz test | `fuzz::ipc::framing_payload_caps` |
