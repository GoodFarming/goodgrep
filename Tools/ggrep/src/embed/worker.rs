...
//!
//! Provides concurrent embedding processing for bulk indexing. This pool is
//! scoped to the lifetime of the CLI process; workers shut down when the
//! [`EmbedWorker`] is dropped.
